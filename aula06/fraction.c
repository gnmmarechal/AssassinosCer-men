...
int FractionEquals (PtFraction pfrac1, PtFraction pfrac2)
{
	...
	Error = OK;
	// Prevenir situações em que o utilizador "força" a entrada de dados
...
int FractionCompareTo(PtFraction pfrac1, PtFraction pfrac2)
{
	...
	return FractionGetNumerator(pfrac1) * FractionGetDenominator(pfrac2) - FractionGetNumerator(pfrac2) * FractionGetDenominator(pfrac1);
}
...
int FractionIsProper(PtFraction pfrac)
{
	...
	if(FractionGetNumerator(pfrac) < FractionGetDenominator(pfrac) && FractionGetNumerator(pfrac) >= 0) return 1;
	if(- FractionGetNumerator(pfrac) < FractionGetDenominator(pfrac) && FractionGetNumerator(pfrac) < 0) return 1;
	return 0;
}
...
char * FractionToString(PtFraction pfrac)
{
	...
	char * Str;
	/* cria a sequência de caracteres */
