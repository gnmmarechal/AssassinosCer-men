...
{
	/* Exitem duas formas de realizar esta comparação
	 * - Comparar todos os nodes de cada fração  -> Método com maior precisão
	 * - Comparar a fração soma FractionToFraction
	 */
